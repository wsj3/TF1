...
function Appointments2() {
  ...
  return (
    <Layout>
      <Head>
        <title>Appointments (v2) | Therapist's Friend</title>
      </Head>
      
      <div className="p-6">
        <div className="flex justify-between items-center mb-6">
          <h1 className="text-2xl font-bold text-white">Appointments - Completely New Page (March 5)</h1>
        ...
        {/* Alert about new page */}
        <div className="mb-6 p-4 bg-yellow-900 bg-opacity-50 rounded-md text-yellow-200 border border-yellow-700">
          <p className="font-medium">⚠️ This is a completely new route at <code className="bg-gray-800 px-1 rounded">/appointments2</code></p>
          <p className="text-sm mt-1">We created this to bypass any caching or routing issues. The original appointments page might still show old content due to caching.</p>
        </div>
            ...
            <div className="grid grid-cols-2 gap-4 text-sm mb-4">
              <div className="bg-gray-700 p-3 rounded">
                ...
                <div className="text-gray-300">
                  ...
                  <p>Page version: v2 (March 5, 2025, bypass cache)</p>
                </div>
              </div>
...
export default withAuth(Appointments2); 